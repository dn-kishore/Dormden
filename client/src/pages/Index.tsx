...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <section className="min-h-screen bg-black flex items-center pt-16 relative overflow-hidden">
        ...
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl w-full relative z-10">
          <div className="relative">
            <div className="lg:w-2/3">
              {/* Small Badge */}
              <p className="text-sm font-normal tracking-widest text-gray-300 uppercase animate-fade-in-up">
                Trusted by 10,000+ Students Across India
              </p>
              
              {/* Large Headline with Gradient */}
              <h1 className="mt-6 text-4xl font-normal text-white sm:mt-10 sm:text-5xl lg:text-6xl xl:text-8xl leading-tight animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
              ...
              {/* Description */}
              <p className="max-w-lg mt-4 text-xl font-normal text-gray-400 sm:mt-8 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
      ...
      <section className="py-16 md:py-20 border-y border-border/30 bg-white relative overflow-hidden">
        {/* Subtle gradient overlay */}
        <div className="absolute inset-0 bg-gradient-to-r from-blue-50/50 via-transparent to-green-50/50" />
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div
                  key={index}
                  className="group p-8 rounded-2xl bg-white border border-gray-200 shadow-sm hover:shadow-xl hover:scale-105 hover:-translate-y-1 transition-all duration-300"
                >
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div
                  key={index}
                  className="p-8 rounded-2xl bg-white border border-gray-200 shadow-sm hover:shadow-xl hover:scale-105 transition-all duration-300"
                >
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {featuredListings.map((listing) => (
                ...
                >
                  <div className="rounded-2xl overflow-hidden bg-white border border-gray-200 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                    {/* Image */}
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              ...
              <Link to="/search">
                <Button variant="outline" size="xl" className="w-full sm:w-auto border-white/40 text-white hover:bg-white/10 hover:scale-105 transition-transform font-semibold">
                  Learn more
                </Button>
              </Link>
            </div>
